...
def loginPage(logdata):
    ...
    log.configure(width = 15,height=1,fg='white',bg='black' , relief = FLAT)
...
#        L2.config(text="Username is "+z[0][0]+"\nPassword is "+z[-1][1])
    ...
    sp.configure(width = 15,height=1, fg="white", bg="black", relief = FLAT)
    sp.place(relx=0.4,rely=0.8)

    log = Button(sup_frame,text='Already have a Account?',padx=5,pady=5,width=5,command = gotoLogin,bg="white")
    log.configure(width = 16,height=1, fg="black", bg="white", relief = FLAT)
